...
Public Class ClsMedClaimsettlement
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save Journal
            Dim strCommand As String = "SP_TRANS_MEDCLAIMSETTLEMENT_SAVE"
    ...
    Public Function SELECTCLAIM() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_MEDCLAIMSETTLEMENT_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function UPDATE() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_MEDCLAIMSETTLEMENT_update"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As DataTable
        Dim dtTable As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_MEDCLAIMSETTLEMENT_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function CLOSE() As Integer
        ...
        Try
            Dim strCommand As String = "SP_TRANS_MEDCLAIMSETTLEMENT_CLOSE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@SETTLENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@Cmpid", alParaval(1)))
