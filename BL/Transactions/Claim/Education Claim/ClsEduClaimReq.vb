...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            'save Journal
            Dim strCommand As String = "SP_TRANS_EDUCLAIMREQ_SAVE"
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@TOTALCLAIEDU", alParaval(I)))
                I += 1
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@CLAIEDU", alParaval(I)))
                I += 1
    ...
    Public Function SELECTCLAIM() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_EDUCLAIMREQ_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function update() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_EDUCLAIMREQ_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As DataTable
        Dim dtTable As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_EDUCLAIMREQ_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function CLOSE() As Integer
        ...
        Try
            Dim strCommand As String = "SP_TRANS_EDUCLAIMREQ_CLOSE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@REQNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@Cmpid", alParaval(1)))
