...
Public Class ClsDocumentInward
...
#Region "Function"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_DOCUMENTINWARD_SAVE"
            ...
            With alParameter
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@INMODE", alParaval(I)))
                I += 1
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_TRANS_DOCUMENTINWARD_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_TRANS_DOCUMENTINWARD_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function GETDOC() As DataTable
        ...
        Try
            strcommand = "SP_TRANS_SELECT_DOCUMENTINWARD"
