...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save INMODEMaster
            Dim strCommand As String = "SP_MASTER_INMODEMASTER_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save INMODEMaster
            Dim strCommand As String = "SP_MASTER_INMODEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@INMODEid", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            strcommand = "SP_MASTER_INMODEMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INMODE", alParaval(0)))
