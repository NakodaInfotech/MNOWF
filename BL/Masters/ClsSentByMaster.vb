...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save SENTBYMaster
            Dim strCommand As String = "SP_MASTER_SENTBYMASTER_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save SENTBYMaster
            Dim strCommand As String = "SP_MASTER_SENTBYMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@SENTBYid", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            strcommand = "SP_MASTER_SENTBYMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@SENTBY", alParaval(0)))
