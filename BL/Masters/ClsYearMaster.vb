    ...
    Public Function save() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@TAXASSNO", alParaval(30)))
                .Add(New SqlClient.SqlParameter("@ITWARDNO", alParaval(31)))
                .Add(New SqlClient.SqlParameter("@DEDUCTORTYPE", alParaval(32)))
                .Add(New SqlClient.SqlParameter("@RESPONSIBLE", alParaval(33)))
                .Add(New SqlClient.SqlParameter("@DESIGNATION", alParaval(34)))
                .Add(New SqlClient.SqlParameter("@cmppassword", alParaval(35)))
                .Add(New SqlClient.SqlParameter("@cmpuserid", alParaval(36)))
                .Add(New SqlClient.SqlParameter("@cmptransfer", alParaval(37)))
            ...
            With alParameter
                .Add(New SqlClient.SqlParameter("@cmpname", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@yearstart", alParaval(38)))
                .Add(New SqlClient.SqlParameter("@yearend", alParaval(39)))
                .Add(New SqlClient.SqlParameter("@userid", alParaval(36)))
                .Add(New SqlClient.SqlParameter("@locationid", "0"))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(37)))
                .Add(New SqlClient.SqlParameter("@cmpwithotsp", alParaval(41)))
            End With
            intResult = objDBOperation.executeNonQuery(strCommand, alParameter)
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@DESIGNATION", alParaval(34)))
                .Add(New SqlClient.SqlParameter("@cmppassword", alParaval(35)))
                .Add(New SqlClient.SqlParameter("@TEMPCMPNAME", alParaval(41)))
