...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save DOCTYPEMaster
            Dim strCommand As String = "SP_MASTER_DOCTYPEMASTER_SAVE"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save DOCTYPEMaster
            Dim strCommand As String = "SP_MASTER_DOCTYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@DOCTYPEid", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            strcommand = "SP_MASTER_DOCTYPEMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@DOCTYPE", alParaval(0)))
