...
#Region "Function"
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(7)))
                .Add(New SqlClient.SqlParameter("@NARRATIONid", alParaval(8)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            strcommand = "SP_MASTER_NARRATIONMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@NARRATIONID", alParaval(0)))
            End With
