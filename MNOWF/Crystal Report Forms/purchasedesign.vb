...
Public Class purchasedesign
    ...
    Private Sub purchasedesign_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub purchasedesign_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            strsearch = "(" & strsearch & ")"
            strsearch = strsearch & "  and {REPORT_SP_purchaseSUMMARY.bill_cmpid}=" & CmpId & " and {REPORT_SP_purchaseSUMMARY.bill_locationid}=" & Locationid & " and {REPORT_SP_purchaseSUMMARY.bill_yearid}=" & YearId
