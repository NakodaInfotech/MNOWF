...
Partial Class BS
    ...
    Private Sub InitializeComponent()
        ...
        Me.TabPage1.Size = New System.Drawing.Size(1050, 465)
    ...
    Friend WithEvents rddetails As RadioButton
    Friend WithEvents rdledger As RadioButton
    Friend WithEvents rdcondensed As RadioButton
    ...
    Friend WithEvents gridassets As DataGridView
    Friend WithEvents GASSNAME As DataGridViewTextBoxColumn
    Friend WithEvents GASSDR As DataGridViewTextBoxColumn
    Friend WithEvents GASSCR As DataGridViewTextBoxColumn
    Friend WithEvents gridliabilities As DataGridView
    Friend WithEvents GLIANAME As DataGridViewTextBoxColumn
    Friend WithEvents GLIADR As DataGridViewTextBoxColumn
    Friend WithEvents GLIACR As DataGridViewTextBoxColumn
