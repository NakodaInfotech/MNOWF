...
Public Class ExpenseVoucherDetails
    ...
    Sub fillgrid(ByVal tepmcondition)
        Try
            ...
            Dim dt As DataTable
            dt = objclsCMST.search("  dbo.NONPURCHASE.NP_NO AS [Sr. No], dbo.NONPURCHASE.NP_DATE AS Date, dbo.LEDGERS.ACC_cmpname AS [Party Name], dbo.NONPURCHASE.NP_REFNO AS [PartyBillNo], dbo.NONPURCHASE.NP_partybilldate AS [PartyBillDate], dbo.NONPURCHASE.NP_TOTALAMT AS [Total Amt.], dbo.NONPURCHASE.NP_REMARKS AS [Remarks]  ", "", "  dbo.NONPURCHASE INNER JOIN dbo.LEDGERS ON dbo.NONPURCHASE.NP_LEDGERID = dbo.LEDGERS.ACC_id AND dbo.NONPURCHASE.NP_CMPID = dbo.LEDGERS.ACC_cmpid AND dbo.NONPURCHASE.NP_LOCATIONID = dbo.LEDGERS.ACC_locationid AND dbo.NONPURCHASE.NP_YEARID = dbo.LEDGERS.ACC_yearid", tepmcondition)
