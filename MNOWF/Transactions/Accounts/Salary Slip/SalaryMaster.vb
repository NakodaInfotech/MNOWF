...
Public Class SalaryMaster
    ...
    Sub FILLCMB()
        Try
            ...
            fillledger(CMBDEBITLEDGER, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses') ")
            fillledger(CMBCREDITLEDGER, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
            fillledger(CMBDEDUCTION, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
            fillledger(CMBEARNINGS, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        ...
        Try
            ...
            If edit = True Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    CMBDEBITLEDGER.Text = dt.Rows(0).Item("DEBITLEDGERS")
                    CMBCREDITLEDGER.Text = dt.Rows(0).Item("CREDITLEDGERS")
    ...
    Private Function errorvalid() As Boolean
        ...
        If edit = False Then
            ...
            If DT.Rows.Count > 0 Then
                If MsgBox("Salary for selected Month Already Present, Wish to Proceed?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
    ...
    Private Sub CMBNAME_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMBNAME.Validated
        Try
            'INITIALLY EDIT CODE WAS NOT WRITTEN SO IF WE MAKE ANY CHANGES IN THE AMOUNT AND WE VALIDATE THE NAME THEN FIGURES WERE CHANGED
    ...
    Sub DELETE()
        Try
            ...
            If MsgBox("Delete Entry Permanently?", MsgBoxStyle.YesNo, "MNOWF") = MsgBoxResult.No Then Exit Sub
            ...
            OBJSAL.alParaval = ALPARAVAL
            Dim DT As DataTable = OBJSAL.DELETE()
    ...
    Private Sub CMBDEDUCTION_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMBDEDUCTION.Enter
        Try
            If CMBDEDUCTION.Text.Trim = "" Then fillledger(CMBDEDUCTION, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBDEDUCTION_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBDEDUCTION.Validating
        Try
            If CMBDEDUCTION.Text.Trim <> "" Then ledgervalidate(CMBDEDUCTION, CMBACCCODE, e, Me, TXTDEDADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBEARNINGS_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles CMBEARNINGS.Enter
        Try
            If CMBEARNINGS.Text.Trim = "" Then fillledger(CMBEARNINGS, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBEARNINGS_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles CMBEARNINGS.Validating
        Try
            If CMBEARNINGS.Text.Trim <> "" Then ledgervalidate(CMBEARNINGS, CMBACCCODE, e, Me, TXTDEDADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Indirect Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Income'  OR GROUPMASTER.GROUP_SECONDARY = 'Duties & Taxes' OR GROUPMASTER.GROUP_SECONDARY = 'Loans & Advances'  OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub TXTDEDAMT_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTDEDAMT.Validating
        Try
            'ALLOW 0 VALUES AS  WE NEED UNIFORMITY OF COLUMNS IN EXCEL PRINT FORMAT, AS PER NAZIM BHAI
            If CMBDEDUCTION.Text.Trim <> "" Then
                FILLDED()
            Else
    ...
    Sub PRINTREPORT(ByVal SALNO As Integer)
        Try
            ...
            OBJSAL.WHERECLAUSE = " {SALARYMASTER.SAL_NO}= " & SALNO & "  and {SALARYMASTER.SAL_YEARID} = " & YearId
            OBJSAL.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub CMBDEBITLEDGER_Enter(sender As Object, e As EventArgs) Handles CMBDEBITLEDGER.Enter
        Try
            If CMBDEBITLEDGER.Text.Trim = "" Then fillledger(CMBDEBITLEDGER, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBDEBITLEDGER_Validating(sender As Object, e As CancelEventArgs) Handles CMBDEBITLEDGER.Validating
        Try
            If CMBDEBITLEDGER.Text.Trim <> "" Then ledgervalidate(CMBDEBITLEDGER, CMBACCCODE, e, Me, TXTDEDADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses')", "Direct Expenses")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub CMBCREDITLEDGER_Enter(sender As Object, e As EventArgs) Handles CMBCREDITLEDGER.Enter
        Try
            If CMBCREDITLEDGER.Text.Trim = "" Then fillledger(CMBCREDITLEDGER, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities') ")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub

    Private Sub CMBCREDITLEDGER_Validating(sender As Object, e As CancelEventArgs) Handles CMBCREDITLEDGER.Validating
        Try
            If CMBCREDITLEDGER.Text.Trim <> "" Then ledgervalidate(CMBCREDITLEDGER, CMBACCCODE, e, Me, TXTDEDADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'Indirect Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Direct Expenses' OR GROUPMASTER.GROUP_SECONDARY = 'Current Liabilities')", "Direct Expenses")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
