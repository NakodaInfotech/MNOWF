    ...
    Sub showform()
        Try
            If gridregister.RowCount > 0 Then
                ...
                If dtrow(2).ToString = "MEDICAL" Then
                ...
                ElseIf dtrow(2).ToString = "EDUCATION" Then
                ...
                ElseIf dtrow(2).ToString = "BOOKING" Then
                ...
                ElseIf dtrow(2).ToString = "REFUND" Then
                ...
                ElseIf dtrow(2).ToString = "SALARY" Then
