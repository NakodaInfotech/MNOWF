...
Public Class PaymentDetails
    ...
    Private Sub CHQPRINTTOOL_Click(sender As Object, e As EventArgs) Handles CHQPRINTTOOL.Click
        Try
            If gridpayment.SelectedRowsCount = 0 Then Exit Sub
    ...
    Sub SERVERPROPSELECTED()
        Try
            ...
            Dim MULTIPAYNO As String = ""
            Dim SELECTEDROWS As Int32() = gridpayment.GetSelectedRows()
            For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                Dim ROW As DataRow = gridpayment.GetDataRow(SELECTEDROWS(I))
                If MULTIPAYNO = "" Then MULTIPAYNO = "[" & Val(ROW("Sr. No")) Else MULTIPAYNO = MULTIPAYNO & "," & Val(ROW("Sr. No"))
            Next
            If MULTIPAYNO <> "" Then MULTIPAYNO = MULTIPAYNO & "]"
