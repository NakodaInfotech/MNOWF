...
Public Class MergeLedger
    ...
    Private Sub cmbmergename_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbmergename.Validating
        Try
            If cmbmergename.Text.Trim <> "" Then ledgervalidate(cmbmergename, CMBMERGECODE, e, Me, txtadd, " AND ledgers.acc_cmpname = '" & cmbmergename.Text.Trim & "' and acc_cmpid = " & CmpId & " and acc_LOCATIONid = " & Locationid & " and ACC_YEARID = " & YearId)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
