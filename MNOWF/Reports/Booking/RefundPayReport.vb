...
Public Class RefundPayReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MNOWF.RefundPayReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRefundPayReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RefundPayReport = New RefundPayReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
