...
Public Class CorresOffReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MNOWF.CorresOffReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCorresOffReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CorresOffReport = New CorresOffReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
