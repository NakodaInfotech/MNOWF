...
Public Class CorresCmpReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MNOWF.CorresCmpReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCorresCmpReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CorresCmpReport = New CorresCmpReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
