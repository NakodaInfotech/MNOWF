...
Public Class PaymentClaimReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MNOWF.PaymentClaimReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentClaimReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentClaimReport = New PaymentClaimReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
