...
Public Class TDS_Form16ANew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MNOWF.TDS_Form16ANew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTDS_Form16ANew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TDS_Form16ANew = New TDS_Form16ANew()
        rpt.Site = Me.Site
        Return rpt
    End Function
