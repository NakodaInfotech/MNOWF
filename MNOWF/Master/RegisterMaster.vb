...
Public Class RegisterMaster
    ...
    Private Sub RegisterMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ElseIf frmstring = "MEDICAL" Then
                Me.Text = "Medical Register"
                lbl.Text = "Medical Register"
            ElseIf frmstring = "EDUCATION" Then
                Me.Text = "Education Register"
                lbl.Text = "Education Register"
            ElseIf frmstring = "BOOKING" Then
                Me.Text = "Booking Register"
                lbl.Text = "Booking Register"
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        Try
            ...
            If edit = True Then
                ...
                Dim tempmsg As Integer = MsgBox("Delete Register Permanently?", MsgBoxStyle.YesNo, "MNOWF")
                If tempmsg = vbYes Then
