...
Public Class EmployeeMaster
        ...
        Try
            ...
            If edit = True Then
                ...
                If dttable.Rows.Count > 0 Then
                    ...
                    DOJ.Value = Convert.ToDateTime(dttable.Rows(0).Item("DOJ")).Date
                    ...
                    TXTBANKNAME.Text = dttable.Rows(0).Item("BANKNAME").ToString
                    TXTACNO.Text = dttable.Rows(0).Item("ACNO").ToString
                    TXTIFSCCODE.Text = dttable.Rows(0).Item("IFSCCODE").ToString
    ...
    Sub GETMAX_USERID()
        Dim DTTABLE As New DataTable
        DTTABLE = getmax(" isnull(max(EMP_ID),0) + 1 ", "EMPLOYEEMASTER", " AND EMP_cmpid=" & CmpId & " AND EMP_LOCATIONid=" & Locationid & " AND EMP_YEARid=" & YearId)
        If DTTABLE.Rows.Count > 0 Then
            TXTENROLLNO.Text = DTTABLE.Rows(0).Item(0)
        End If
    End Sub
