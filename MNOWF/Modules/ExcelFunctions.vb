...
fontItalic As Boolean = False)
    ...
    Sub EXCELCMPHEADER(ByVal PATH As String, ByVal REPORTTITLE As String, ByVal COLS As Integer, Optional ByVal NAME As String = "", Optional ByVal PERIOD As String = "", Optional ByVal OPENING As String = "", Optional ByVal CLOSING As String = "", Optional ByVal SRNO As Boolean = False)
        Try
            Dim OBJEXCEL As New Excel.Application
            Dim OBJBOOK As Excel.Workbook = OBJEXCEL.Workbooks.Open(PATH)
            Dim OBJSHEET As Excel.Worksheet = OBJBOOK.Sheets(1)

            ' If SRNO = True Then INSERTSRNO(OBJSHEET, CmpId, REPORTTITLE, COLS, NAME, PERIOD, OPENING, CLOSING)
            CMPHEADER(OBJSHEET, CmpId, REPORTTITLE, COLS + 1, NAME, PERIOD, OPENING, CLOSING, SRNO)
    ...
    Sub CMPHEADER(ByVal OBJSHEET As Excel.Worksheet, ByVal CMPID As Integer, ByVal REPORTTITLE As String, ByVal COLS As Integer, ByVal NAME As String, ByVal PERIOD As String, ByVal OPENING As String, ByVal CLOSING As String, Optional ByVal SRNO As Boolean = False)
        Try
            '''''''''''Report Title
            ...
            If SRNO = True Then SetColumnWidth(OBJSHEET, Range("1"), 4)
            ...
            If PERIOD <> "" Then Write(OBJSHEET, "Period : " & PERIOD, Range("1"), XlHAlign.xlHAlignCenter, Range(COLS), True, 8)
    ...
    Sub INSERTSRNO(ByVal OBJSHEET As Excel.Worksheet, ByVal CMPID As Integer, ByVal REPORTTITLE As String, ByVal COLS As Integer, ByVal NAME As String, ByVal PERIOD As String, ByVal OPENING As String, ByVal CLOSING As String)
        Try
            ...
            ROWINDEX = 1
            Write(OBJSHEET, "Sr", Range("1"), XlHAlign.xlHAlignLeft, Range("1"), True, 8)

            ROWINDEX += 1
            For I = 1 To OBJSHEET.UsedRange.Rows.Count - 2
                Write(OBJSHEET, I, Range("1"), XlHAlign.xlHAlignLeft, Range("1"), False, 8)
                ROWINDEX += 1
            Next
