...
Public Class filter
    ...
    Sub fillgrid()
        ...
        Try
            ...
            Dim dt As DataTable
            If frmstring = "purchasedetails" Or frmstring = "purchasesummary" Or frmstring = "PaymentDetails" Or frmstring = "AdvancesPaidReport" Then
            ...
            ElseIf frmstring = "saledetails" Or frmstring = "salesummary" Or frmstring = "ReceiptDetails" Or frmstring = "AdvancesReceiveReport" Then
                dt = objclspo.search("    dbo.LEDGERS.Acc_cmpname as [NAME], dbo.LEDGERS.Acc_id ", "", "     dbo.LEDGERS INNER JOIN dbo.GROUPMASTER ON dbo.LEDGERS.Acc_groupid = dbo.GROUPMASTER.group_id AND dbo.LEDGERS.Acc_locationid = dbo.GROUPMASTER.group_locationid And dbo.LEDGERS.Acc_cmpid = dbo.GROUPMASTER.group_cmpid And dbo.LEDGERS.Acc_YEARid = dbo.GROUPMASTER.group_YEARid", " and acc_cmpid = " & CmpId & " and acc_LOCATIONid = " & Locationid & " and acc_YEARid = " & YearId & "  order by dbo.LEDGERS.Acc_cmpname")
    ...
    Private Sub cmbregister_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbregister.Enter
        Try
            ...
            ElseIf frmstring = "PaymentDetails" Or frmstring = "AdvancesPaidReport" Then
            ...
            ElseIf frmstring = "ReceiptDetails" Or frmstring = "AdvancesReceiveReport" Then
        ...
        Try
            ...
            ElseIf frmstring = "saledetails" Or frmstring = "salesummary" Then
                ...
                For i = 0 To gridledger.RowCount - 1
                    If gridledger.Item(0, i).Value = True Then
                        If objpur.strsearch = "" Then
                            objpur.strsearch = objpur.strsearch & "  {REPORT_SP_INVOICESUMMARY.Acc_cmpname}= '" & gridledger.Item(1, i).Value.ToString & "'"
                        Else
                            objpur.strsearch = objpur.strsearch & " or {REPORT_SP_INVOICESUMMARY.Acc_cmpname}= '" & gridledger.Item(1, i).Value.ToString & "'"
                        End If
                    End If
                Next
                If objpur.strsearch = "" Then
                ...
                End If
                If cmbregister.Text <> "" Then
                    objpur.strsearch = objpur.strsearch & " and ({REPORT_SP_INVOICESUMMARY.register_name}='" & cmbregister.Text & "')"
                End If
                If chkdate.Checked = True Then
                    objpur.FROMDATE = dtfrom.Value.Date
                    objpur.TODATE = dtto.Value.Date
