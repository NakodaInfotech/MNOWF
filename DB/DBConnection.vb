...
Public Class DBConnection
    ...
    ''Public Shared ConnectionString As String = "Data Source=SERVER;Initial Catalog=MNOWF;User ID=sa;Password=cl@ss1c;connection timeout=2000"
    'Public Shared ConnectionString As String = "Data Source=" & SERVERNAME & ";Initial Catalog=MNOWF;Integrated Security=True;connect timeout=9999"
